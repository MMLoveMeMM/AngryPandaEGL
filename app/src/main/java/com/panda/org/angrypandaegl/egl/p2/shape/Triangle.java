...
import com.panda.org.angrypandaegl.egl.p2.matrix.MatrixState;
import com.panda.org.angrypandaegl.egl.p2.shader.ShaderRes;
import com.panda.org.angrypandaegl.egl.p2.shader.ShaderState;
...
public class Triangle implements IShape{
    ...
    private MatrixState mMatrix = new MatrixState();
    ...
    public void initShader() {
        ShaderRes mat = new ShaderRes(mContext);
        mat.setMaterialName("gles_triangle.mat");
        mProgram = ShaderState.getProgramFromAsset(mContext, mat);
        // 获取程序中顶点位置属性引用id
    ...
    public void onDrawSelf() {
        ...
        //
        GLES20.glUniformMatrix4fv(muMVPMatrixHandle, 1, false, MatrixState.getFinalMatrix()/*mMatrix.getFianlMatrix(mMatrix.mMMatrix)*/, 0);
